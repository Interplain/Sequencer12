...
Built on STM32F405RGT6 with a 240x320 ST7789 SPI display, calibrated multi-channel CV output, persistent FRAM storage, and a deterministic embedded runtime architecture.
...
| CV Inputs | Multi-channel ADC architecture (planned expansion) |
