...
static void WriteReg(I2C_HandleTypeDef *hi2c, uint8_t reg, uint8_t val)
{
    ...
    HAL_I2C_Master_Transmit(hi2c, MCP23017_ADDR, buf, 2, 10);
}
...
{
    uint8_t val = 0;
    HAL_I2C_Master_Transmit(hi2c, MCP23017_ADDR, &reg, 1, 10);
    HAL_I2C_Master_Receive (hi2c, MCP23017_ADDR, &val, 1, 10);
    return val;
}
